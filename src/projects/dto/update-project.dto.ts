...
export class UpdateProjectDto {
  @ApiPropertyOptional({ description: 'Project title, max 200 characters.', maxLength: 200 })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'URL slug: lowercase letters, digits, hyphens. Max 200 characters.', maxLength: 200 })
  @IsOptional()
